              ...
              <td align="center" valign="top">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                   ...
                   <tr>
                    <td height="10" style="font-size:10px; line-height:10px;"><?php echo $subject; ?></td>
                  </tr>
                ...
                <table width="500" cellpadding="0" cellspacing="0" border="0" class="container">
                  ...
                  <tr>
                    <td align="center" valign="top" style="color: #7C7C7C; padding:0 10px; font-size:1.2em; line-height:1.8em;">
                        Many congratulations on successfully signing up with us. Thank you for creating your account at SJFX. Your account details are as follows.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" style ="border:1px solid #388cda">
                      <p>
                        <b>Email address :</b> <?php echo $email; ?>
                      </p>
                      <p>
                        <b>Sponsor Name :</b> <?php echo $sponsor; ?>
                      </p>
