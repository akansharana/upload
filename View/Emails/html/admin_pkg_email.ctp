      ...
      <tr>
        <td class="email_body email_start tc">
          <table role="presentation" class="content_section" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                <td class="content_cell  pb brt tc">
                  <div class="col_1">
                    <table role="presentation" class="column" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        <tr>
                          <td class="column_cell sc logo_c pt ">
                            <a href="#"><img src="http://shinegenexcrm.com/frontend_new/images/logo.png" width="136" height="32" alt="" style="max-width:140px;"></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
      ...
      <tr>
        <td class="email_body tc">
          <table role="presentation" class="content_section" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                <td class="content_cell default_b hero_image py tc" background="http://shinegenexcrm.com/frontend_new/images/hero_background.png">
                  <table role="presentation" class="column" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td class="column_cell sc tc">
                          <h1 class="sc">Welcome to SJFX family !!!</h1>
                          <p st>We have received package purchase request for member. <br> Here are the details with regards to the requested plan.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td style="color:#333;font-weight:500;font-size:15px">
                            <div
                                style="padding:15px;border:2px solid #e2e8e9;color:white;">
                  ...
                  <div class="col_12">
                    <table role="presentation" class="column" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        <tr>
                          <td class="column_cell sc pte tc">
                            <table role="presentation" class="ic_h" align="center" width="64" border="0" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <td class="content_b"><img role="img" src="http://shinegenexcrm.com/frontend_new/images/calendar.png" width="48" height="48" alt="Calendar symbol" style="max-width:48px;"></td>
                                </tr>
                              </tbody>
                            </table>
                            <p class="mt_xs mb_0">15 September</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                        ...
                        <tr>
                          <td class="column_cell sc pte tc">
                            <table role="presentation" class="ic_h" align="center" width="64" border="0" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <td class="content_b"><img role="img" src="http://shinegenexcrm.com/frontend_new/images/time.png" width="48" height="48" alt="Clock symbol" style="max-width:48px;"></td>
                                </tr>
                              </tbody>
                            </table>
                            <p class="mt_xs mb_0">7:30 AM</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                        ...
                        <tr>
                          <td class="column_cell sc pte tc">
                            <table role="presentation" class="ic_h" align="center" width="64" border="0" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <td class="content_b"><img role="img" src="http://shinegenexcrm.com/frontend_new/images/shopping-cart.png" width="48" height="48" alt="Group symbol" style="max-width:48px;"></td>
                                </tr>
                              </tbody>
                            </table>
                            <p class="mt_xs mb_0">? 5000 /-</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
      ...
      <tr>
        <td class="email_body email_end tc">
          <table role="presentation" class="content_section" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                <td class="content_cell footer_ pb brb tc">
                  <div class="col_3">
                    <table role="presentation" class="column" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        <tr>
